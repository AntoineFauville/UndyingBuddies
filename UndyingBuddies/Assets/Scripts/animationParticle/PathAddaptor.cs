...
public class PathAddaptor : MonoBehaviour
{
    ...
    public void Setup(GameObject startingPoint, GameObject endingPoint, ParticleFlowManager particleFlowManager)
    {
    ...
    void AdjustPosition()
    {
        ...
        _particleFlowManager.Points[1].transform.position = new Vector3(_startingPoint.transform.position.x, _startingPoint.transform.position.y + 5, _startingPoint.transform.position.z);

        _particleFlowManager.Points[2].transform.position = new Vector3(_endingPoint.transform.position.x, _endingPoint.transform.position.y + 5, _endingPoint.transform.position.z);
