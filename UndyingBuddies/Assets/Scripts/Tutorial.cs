...
public class Tutorial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tutorialContent.text = "Two scout demons have spotted villages of priest near them, scrared, they created a small autel to summon you. " + "\n" +
            ...
            "With these resource, create a factory to rafine your resources, to have one of your demon work in the factory, simply grab him and place him on the building" + "\n" +
