...
public class Tutorial : MonoBehaviour
{
    ...
    {
        //part 1 //setup
        title.text = "1/6 You just got summoned!";
        ...
        title6.text = "6/6 Tips on Attacking";
